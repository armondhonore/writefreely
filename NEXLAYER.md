...
**Live:** [https://relaxed-weasel-writefreely.cloud.nexlayer.ai](https://relaxed-weasel-writefreely.cloud.nexlayer.ai)  
...
**writefreely** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/algernon/writefreely:latest
    path: /
    servicePorts:
    - 8080
    vars:
